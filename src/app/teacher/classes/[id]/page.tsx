        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <FeatureNote
              ...
              details={[
                "👥 학생 목록: 클래스에 등록된 모든 학생들의 정보와 참여 현황을 확인할 수 있습니다",
                "📊 프로젝트 현황: 각 학생의 탐구 프로젝트 진행 상황을 실시간으로 모니터링할 수 있습니다",
                "🏷️ 상태별 분류: 초안, 진행중, 완료, 제출 상태별로 프로젝트를 구분하여 효율적으로 관리합니다",
                "🔍 개별 관리: 각 학생의 프로젝트를 클릭하여 상세 내용을 확인하고 단계별 피드백을 제공할 수 있습니다",
                "📈 통계 정보: 클래스 전체의 프로젝트 진행률과 완료율을 한눈에 확인할 수 있습니다",
                "💬 피드백 관리: 제공한 피드백의 현황과 학생들의 개선 사항을 추적할 수 있습니다"
              ]}
              className="shrink-0"
            />
          </div>
